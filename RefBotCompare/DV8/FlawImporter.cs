...
namespace RefBotCompare.DV8
{
    ...
    {
        public IEnumerable<string> FindMatrices(string directory)
        {
            return FindFilesWithSuffix(directory, MergeDv8DsmSuffix);
        }

        public IEnumerable<string> FindJson(string directory)
        {
        ...
        private IEnumerable<string> FindFilesWithSuffix(string directory, string suffix)
        {
